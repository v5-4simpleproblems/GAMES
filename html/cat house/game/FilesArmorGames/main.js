(function(){
    ...
    Game.addAction("mainmenu", createArmorButton);
    Game.addAction("mainmenu", createFacebookButton);

    Game.addAction("credits", createArmorButton);
    Game.addAction("credits", createFacebookButton);

    Game.addAction("levelselectionmenu", createArmorButton);
    Game.addAction("levelselectionmenu", createFacebookButton);

    Game.addAction("speedrummenu", createArmorButton);
    Game.addAction("speedrummenu", createFacebookButton);

    Game.addAction("level", function(){
        switch(Game.Level.index){
            case 2:case 13:case 16:case 18:case 20:case 21:case 22:case 25:case 26:case 27:
            break;
            case 5:case 17:
