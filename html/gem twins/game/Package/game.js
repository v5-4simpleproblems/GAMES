...
(function (Game) {
    ...
    Engine.System.onInit = function () {
        if (Engine.Data.useLocalStorage) {
            Engine.Data.setID("com", "noa", "gemtwi", "1_0");
        }
        else {
            Engine.Data.setID("c", "n", "gemtwi", "1_0");
        }
...
(function (Game) {
    ...
    (function (Credits) {
        ...
        function maktex() {
            ...
            //behe.xAligned=1.5;
            thutit.yAligned = Credits.big ? devnictwo.y + offtexsep : devnic.y + offtexsep;
            ...
            //behe.xAligned=1.5;
            mustit.yAligned = thunic.y + offtexsep;
...
(function (Game) {
    ...
    (function (devlinund) {
        ...
        spr.enabled = spr.pinned = true;
        Game.addAction("configure", function () {
            Game.FrameSelector.complex("devlinund", Game.Resources.texgam, 793, 187)[0].applyToSprite(spr);
        });
        function mak(x, y) {
